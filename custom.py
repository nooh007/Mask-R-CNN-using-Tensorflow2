...
ROOT_DIR = "C:\\Users\\ForAI\\OneDrive\\Desktop\\DL task\\maskrcnn_implementation\\Mask-R-CNN-using-Tensorflow2"
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        if subset == "train":
            annotations1 = json.load(open('C:\\Users\\ForAI\\OneDrive\\Desktop\\DL task\\maskrcnn_implementation\\Mask-R-CNN-using-Tensorflow2\\dataset\\train\\train_json.json'))
        elif subset == "val":
            annotations1 = json.load(open('C:\\Users\\ForAI\\OneDrive\\Desktop\\DL task\\maskrcnn_implementation\\Mask-R-CNN-using-Tensorflow2\\dataset\\val\\val_json.json'))
        ...
        for a in annotations:
            ...
            name_dict = {"hardhat": 1,"safetyvest": 2}
